...
function angularInit(element, bootstrap) {
  var elements = [element],
      appElement,
      module,
      names = ['ng:app2', 'ng-app2', 'x-ng-app2', 'data-ng-app2'],
 ...
 * @returns {AUTO.$injector} Returns the newly created injector for this app2.
 */
 ...
 * <pre>
 *  // Given:
 *  // URL: http://server.com/ng2-ng-index.html#/Chapter/1/Section/2?search=moby
...
function createHttpBackend($browser, XHR, $browserDefer, callbacks, rawDocument, locationProtocol) {
  ...
  return function(method, url, post, callback, headers, timeout, withCredentials) {
    ...
    if (lowercase(method) == 'jsonp') {
      ...
      // response is in the cache. the promise api will ensure that to the app2 code the api is
      // always async
 ...
 * including the rendered template of the current route into the main layout (`ng2-ng-index.html`) file.
